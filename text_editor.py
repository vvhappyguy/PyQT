...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        saveas_file_action = QAction(QIcon(os.path.join('images', 'saveas.png')), "Save As...", self)
        ...
        select_action = QAction(QIcon(os.path.join('images', 'select.png')), "Select all", self)
    ...
    def update_title(self):
        self.setWindowTitle("%s - DyakED" % (os.path.basename(self.path) if self.path else "Untitled"))
